...
class AdvSearchForm extends React.Component{
    constructor(props){
        ...
        this.handleBrwBefChange = this.handleBrwBefDateChange.bind(this);
        this.handleBrwAftChange = this.handleBrwAftDateChange.bind(this);
    ...
    handleBrwBefDateChange(date){
        ...
        // Insert date string in input value
                ...
                <Grid  item xs={12}>   
                    ...
                    <div className='slider-field'>
                        <div style={{positon:'relative'}}>
                            <DatePicker
                                ...
                                onChange={this.handleBrwBefDateChange}
                            />
                        </div>
                    </div>
                    ...
                    <div className='slider-field'>
                        ...
                        <DatePicker
                            ...
                            onChange={this.handleBrwAftDateChange}
                        />
                        </div>
                    </div>
